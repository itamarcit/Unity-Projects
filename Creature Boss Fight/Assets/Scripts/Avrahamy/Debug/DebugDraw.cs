...
namespace Avrahamy {
    public static class DebugDraw {
        ...
        [Conditional("DEBUG_DRAW")]
        private static void DrawSectorXY(Vector3 position, float radius, float sectorStartAngle, float sectorEndAngle, Color color, Action<Vector3, Vector3, Color> DrawLineFunc) {
