...
namespace Avrahamy.Math {
    public static class VectorExtensions {
        ...
        public static Quaternion LookRotation(this Vector2 v) {
            return Quaternion.LookRotation(Vector3.back, v.GetPerpendicularCW());
        }
        ...
        public static Vector3 DivideChannels(this Vector3 lhs, Vector3 rhs) {
            lhs.x /= rhs.x;
            lhs.y /= rhs.y;
            lhs.z /= rhs.z;
            return lhs;
