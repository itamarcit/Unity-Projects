...
namespace CreatureGeneration
{
    ...
    public class LimbMesh : EditableMesh
    {
        ...
        public struct MeshVertex
        {
            ...
            public Vector3 CalculateCurrentPosition(Transform skin, List<Pivot> pivots)
            {
                var weightSum = 0f;
                ...
                return skin.InverseTransformPoint(position / weightSum);
            }
        }
        ...
        protected void Awake()
        {
            ...
            while (joint != null && joint != root)
            {
                ...
                {
                    pivot = joint,
                    originalPositionInMesh = joint.position - transform.position,
                });
                joint = joint.parent;
            }
            ...
            {
                pivot = root,
                originalPositionInMesh = root.position - transform.position,
            });
            ...
            Vector3 bottomCenter)
        {
            ...
            float y = -creatureParent.position.y + bottomCenter.y + Y_DEFAULT;
            float z = Z_DEFAULT;
            ...
            {
                x = X_TAIL;
                y = -creatureParent.position.y + bottomCenter.y + Y_TAIL;
                z = Z_TAIL;
                diff = DIFF_TAIL;
                radius = RADIUS_TAIL;
            }
            ...
            {
                x = X_NECK;
                y = -creatureParent.position.y + bottomCenter.y + Y_NECK;
                z = Z_NECK;
                diff = DIFF_NECK;
                radius = RADIUS_NECK;
            }
